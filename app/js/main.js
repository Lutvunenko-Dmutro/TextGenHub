...
import { loadSettings, saveSettings, saveToHistory, clearHistory } from './storage.js';
    ...
    try {
        ...
        const onComplete = (finalText) => {
            ...
            if (!signal.aborted) {
                ...
                // Splits text into sentences and checks if any sentence repeats 3+ times
                ...
                if (sentences.length >= 3) {
                    ...
                    for (let i = 0; i < sentences.length; i++) {
                        ...
                        if (counts[key] >= 3 && loopStart === -1) {
                            loopStart = i - 2; // cut before first repeat
                        }
                    }
                    if (loopStart > 0) {
